...
if __name__ == '__main__':
    ...
    plt.imsave("test_merge_img.png" , test_merge_img.permute(1, 2, 0).cpu().numpy())
    plt.imsave("test_base_img.png" ,test_base_img.permute(1, 2, 0).cpu().numpy())
    plt.imsave("test_flare_img.png", test_flare_img.permute(1, 2, 0).cpu().numpy())
    print("done")
